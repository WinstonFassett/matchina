...
import { DuckTypedMachine, HierarchicalMachine, PropagatedMachine, RootMachine, OptionalDuckTypedMachine } from "./types";
...
export function nestedHsmRoot<M extends FactoryMachine<any>>(machine: M) {
  ...
  return enhanceWithShape(machine, createLazyShapeStore(machine)) as unknown as HierarchicalMachine<M>;
}
