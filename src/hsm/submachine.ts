...
export function submachine<F extends () => FactoryMachine<any>>(createChild: F): () => { machine: ReturnType<F> };
export function submachine<F extends () => FactoryMachine<any>>(createChild: F, opts: { id?: string }): () => { machine: ReturnType<F>; id?: string };
export function submachine<F extends () => FactoryMachine<any>>(createChild: F, opts?: { id?: string }) {
