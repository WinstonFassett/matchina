...
async function promiseUsage() {
  ...
  type PromiseTransitionStateKeys =
    keyof typeof fetchMachine.context.transitions;
  ...
  type PromiseTransitionEventKeys<T extends PromiseTransitionStateKeys> =
    TransitionEventKeys<typeof fetchMachine.context.transitions, T>;
  ...
  type Idle = PromiseTransitionStateKeys extends infer S
    ? S extends "Idle"
      ? S
      : never
    : never;
  type Pending = PromiseTransitionStateKeys extends infer S
    ? S extends "Pending"
      ? S
      : never
    : never;
  type ExecuteEvents = PromiseTransitionEventKeys<Idle>;
  type ExecuteEventKeys2 = TransitionEventKeys<
    typeof fetchMachine.context.transitions,
    "Idle"
  >;
  type PendingEventKeys2 = TransitionEventKeys<
    typeof fetchMachine.context.transitions,
    "Pending"
  >;
  type StateKeys2 = TransitionStateKeys<
    typeof fetchMachine.context.transitions
  >;
