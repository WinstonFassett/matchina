...
//   FactoryMachine<any>,  
//   typeof handlerNames[number]
// >;


const fromMiddleware = <E>(middleware: Middleware<E>): 
  Funcware<Transitioner<E>["transition"]> => 
