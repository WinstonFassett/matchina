...
**See `300-hsm-deep-dive.md` for detailed exploration.**
...
- [ ] Create `300-hsm-deep-dive.md` with detailed pros/cons analysis
...
**See `301-api-brainstorm.md` for detailed exploration.**
...
- [ ] Create `301-api-brainstorm.md` with fresh API exploration
...
**See `302-packaging.md` for detailed exploration.**
...
- [ ] Create `302-packaging.md` with subpath analysis
...
|----------|---------|--------|
| `300-hsm-deep-dive.md` | Detailed HSM analysis, alternative approaches | ✓ Complete |
| `301-api-brainstorm.md` | API from scratch, definitions vs instances | ✓ Complete |
| `302-packaging.md` | Subpath analysis, what goes where | ✓ Complete |
| `303-visualizers.md` | Inspection and interactive viz review | ✓ Complete |
| `304-conversation-notes.md` | Ongoing discussion and decisions | ✓ Complete |
| `400-work-organization.md` | Pre-merge vs post-merge task breakdown | ✓ Complete |

---

## Open Actions Summary

See `400-work-organization.md` for full breakdown.
