...
const meta: ExampleMeta = {
  ...
  order: 1,
  indexable: false,
  getMachine: () => import("../code/examples/hsm-traffic-light/machine-flat").then((m) => ({ default: m.createFlatTrafficLight })),
  getAppView: () => import("../code/examples/hsm-traffic-light/TrafficLightViewFlat").then((m) => ({ default: m.TrafficLightViewFlat })),
