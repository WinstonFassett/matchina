import { createFactoryMachine, matchboxFactory } from "matchina";
...
const HandshakeProtocol = matchboxFactory(
  {
    ...
    rejected: (handshake: HandshakeContext, reason: string) => ({
      ...handshake,
      reason,
    }),
  },
...
const createHandshakeMachine = (
  name: string,
  options: { maxTries?: number } = {},
) => {
  return createFactoryMachine(
    HandshakeProtocol,
    {
      handshake: {
        accepted: "accepted",
