...
export function FetcherAppView({
  machine,
}: {
  machine: ReturnType<typeof useSumFetcher>;
}) {
  ...
  return (
    <div className="p-4 rounded border">
      ...
      <div className="mb-4">
        <p
          className={`inline-block px-2 py-1 rounded mb-2 ${adder.state.match({
            Idle: () => "bg-gray-200",
            Pending: () => "bg-blue-200",
        ...
        <div className="mt-2">
          ...
          {adder.state.is("Rejected") && (
            <p className="text-red-600">
              Error:{" "}
              {typeof adder.state.data === "object" &&
              adder.state.data &&
              "message" in adder.state.data
