...
- [Lifecycle Hooks](/guides/lifecycle) - Add behavior during state transitions
- [Pattern Matching](/guides/typeguards) - Work with state data in a type-safe way
- [React Integration](/guides/integrations) - Use state context with React components
