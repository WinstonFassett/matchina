...
[Open the live demo →](/matchina/cdn-demos/explore-esmsh/)
...
[Open the live demo →](/matchina/cdn-demos/explore-jsdelivr/)
...
[ArrowJS](https://arrow-js.com/) is one good fit (no-build, tagged template literals, small). [Live demo →](/matchina/cdn-demos/explore-arrow/)
