...
Matchina runs state machines. Rendering is your view library's job. To pair it with a reactive view library over CDN (VanJS, Preact, Solid, Vue, petite-vue, Stimulus), see [HTML Artifacts](/matchina/guides/html-starters) for the patterns, a side-by-side comparison, and heuristics.
