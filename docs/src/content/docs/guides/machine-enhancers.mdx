...
<TabItem label="zen">
  Use `assignEventApi` when: - You need both event methods and state access in a clean
...
// Create a assignEventApi enhancer
const toggle = assignEventApi(toggleMachine);
