...
- Example: Instead of `typed: (value) => value ? "TextEntry" : "Empty"`, use:
  ```typescript
  Typing: {
...
**HSMs Are Footguns**
- Question whether HSMs help or hurt your specific use case
- Most HSMs can be flattened into simple state machines
- Prefer flattening when hierarchy isn't truly necessary
