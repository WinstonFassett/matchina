...
<CardGrid>
  <LinkCard
    title="🔄 Toggle"
    href="/matchina/guides/examples/toggle/"
    description="Simple on/off toggle state machine"
  />
  <LinkCard
    title="📡 Data Fetching"
    href="/matchina/guides/examples/fetcher-advanced/"
    description="Type-safe async data fetching"
  />
  <LinkCard
    title="🚦 Traffic Light"
    href="/matchina/guides/examples/traffic-light/"
