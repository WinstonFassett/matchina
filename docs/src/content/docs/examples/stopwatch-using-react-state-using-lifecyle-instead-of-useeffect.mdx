...
import { Stopwatch } from "@code/examples/stopwatch-using-react-state-using-lifecycle-instead-of-useEffect";
import code from "@code/examples/stopwatch-using-React-state-using-lifecycle-instead-of-useEffect/index.tsx?raw";
