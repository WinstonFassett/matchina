...
---
import { Stopwatch } from '@lib/examples/Stopwatch-with-React-state-and-state-effects.tsx'
import code from '@lib/examples/Stopwatch-with-React-state-and-state-effects.tsx?raw'
