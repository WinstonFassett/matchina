...
<div className="not-content">
  <ExtendedTrafficLightExample client:visible />
</div>

## Implementation Details

This example builds on the basic [Traffic Light](/examples/traffic-light) example by adding:
...
- [Nested States](/guides/nested-states) - Create hierarchical state machines
- [Effect Handlers](/guides/effects) - Add side effects to your transitions
- [History States](/guides/history) - Remember previous states
