...
Now, let's define the transitions and create our form machine. We'll define the transitions inline to maintain full TypeScript inference:
...
```ts
// Create the form machine with inline transitions
const formMachine = matchina(
  formStates,
  {
    Pristine: {
      // ... transitions for Pristine state
    },
    Editing: {
      // ... transitions for Editing state
    },
    Invalid: {
      // ... transitions for Invalid state
    },
    Submitting: {
      // ... transitions for Submitting state
    },
    Success: {
