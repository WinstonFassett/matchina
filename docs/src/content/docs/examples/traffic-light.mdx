...
For a minimal introduction, see the [Quick Start](/matchina/guides/quickstart).
...
Check out the [Extended Traffic Light Example](/matchina/examples/traffic-light-extended) to see the first two extensions implemented (automatic transitions and pedestrian crossing).

## Next Steps

Now that you've seen state machines with varying complexity, you might want to explore:

- [Matchbox Factories](/matchina/guides/matchbox-factories) - Learn more about storing and using data in states
- [Lifecycle Hooks](/matchina/guides/lifecycle) - Add behavior when states change
- [Matchbox Type Inference](/matchina/guides/matchbox-typescript-inference) - Learn about Matchbox type inference
