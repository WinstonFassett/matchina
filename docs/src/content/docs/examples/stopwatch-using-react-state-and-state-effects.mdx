...
import { Stopwatch } from "@code/examples/stopwatch-using-react-state-and-state-effects";
import code from "@code/examples/stopwatch-using-react-state-and-state-effects/index.tsx?raw";
...
<LinkCard title="Effects" href="/guides/effects/" />
