...
---
import { Stopwatch } from '@lib/examples/Stopwatch-using-data-and-transition-functions.tsx'
import code from '@lib/examples/Stopwatch-using-data-and-transition-functions.tsx?raw'
