...
- [Promise Fetcher](/matchina/examples/promise-machine-fetcher) - Basic promise machine pattern
- [State Effects Guide](/matchina/guides/effects) - Learn about effects and lifecycle management
