...
---
import { Stopwatch } from '@lib/examples/Stopwatch-with-React-state-using-lifecycle-instead-of-useEffect.tsx'
import code from '@lib/examples/Stopwatch-with-React-state-using-lifecycle-instead-of-useEffect.tsx?raw'
