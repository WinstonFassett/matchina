...
export default function MatchinaColorPalette() {
  ...
  const ColorSwatch = ({
    ...
    return (
      ...
      >
        <div
          className={`text-center font-mono font-semibold ${size === "small" ? "text-xs" : "text-sm"}`}
          style={{
            color: selectedTheme.type === "dark" ? "#fff" : "#000",
            textShadow:
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {/* Theme Preview */}
      <div
        className="mt-12 p-6 rounded-lg border border-gray-200 dark:border-gray-700"
        style={{
          backgroundColor: getColorValue("base"),
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            <div
              ...
              style={{
                backgroundColor: getColorValue("blue"),
                color: getColorValue("base"),
              }}
            >
              Active State
            </div>
          ...
          <div
            ...
            style={{
              borderColor: getColorValue("surface1"),
              backgroundColor: getColorValue("mantle"),
            }}
          >
            <div className="font-medium mb-2">Container Example</div>
            <div
              className="text-sm"
              style={{ color: getColorValue("subtext1") }}
            >
